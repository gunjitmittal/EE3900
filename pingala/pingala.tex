...
\author{ Gunjit Mittal $^{*}$ %<-this  stops a space
}% <-this % stops a space
...
\begin{lstlisting}
https://github.com/gunjitmittal/EE3900/blob/main/pingala/codes/pingala1.py
\end{lstlisting}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{figs/1.1}
\caption{}
\end{figure}
 \item 
\begin{align}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{figs/1.2}
\caption{}
\end{figure}
 \item 
\begin{align}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{figs/1.3}
\caption{}
\end{figure}
 \item 
\begin{align}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{figs/1.4}
\caption{}
\end{figure}
...
Run the below python code 
\begin{lstlisting}
https://github.com/gunjitmittal/EE3900/blob/main/pingala/codes/pingala2.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
python3 pingala2.py
